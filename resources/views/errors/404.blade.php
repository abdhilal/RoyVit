        ...
        <div class="error-wrapper">
            <div class="container">
                <div class="svg-wrraper">
                    <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 500 500">
                        ...
                        <g id="freepik--character-1--inject-5">
                            ...
                            <path class="shp16"
                                d="M161.66,154.42a18.53,18.53,0,0,0,3.21,3.81,2.91,2.91,0,0,1-2.3.91Z"></path>
                            <path class="shp2"
                            ...
                            <path class="shp2" d="M229.67,238.26a3,3,0,1,1-3.85-1.79A3,3,0,0,1,229.67,238.26Z">
                            </path>
                            <path class="shp11"
                        ...
                        <g id="freepik--character-2--inject-5">
                            ...
                            <path class="shp9"
                                d="M349.25,135a24.53,24.53,0,0,1-4.32,5.11c1,1.33,3.21,1.07,3.21,1.07Z"></path>
                            <path class="shp2"
                ...
                <div class="col-md-8 offset-md-2">
                    <h3> ليس لديك بيانات او لم تختر ملف اساسي</h3>
                    <p class="sub-content"></p><a class="btn btn-primary" href="{{ route('files.index') }}">العودة
                        لادخال بيانات او اختيار ملف </a>
                </div>
            </div>
        </div>
        <!-- error-400 end-->
